<!--
  Template for client/src/components/AppSidebar.vue.

  Adapt to the project's actual route list (discovered in Phase 1) if it differs
  from the 6 routes encoded below. Preserve the Options API + setup() style.
  All styles consume var(--*) tokens — never inline literal hex/rem.
-->
<template>
